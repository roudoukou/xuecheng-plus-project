...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "E:\\Code\\学成在线\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "E:\\Code\\学成在线\\ffmpeg\\20221023_211834.avi";
        //转换后mp4文件的名称
        String mp4_name = "20221023_211834.mp4";
        //转换后mp4文件的路径
        String mp4_path = "E:\\Code\\学成在线\\ffmpeg\\20221023_211834_2.mp4";
        //创建工具类对象
