...
public class MediaFileServiceImpl implements MediaFileService {
    ...
    public PageResult<MediaFiles> queryMediaFiels(Long companyId,
                                                  PageParams pageParams, QueryMediaParamsDto queryMediaParamsDto) {
    ...
    public RestResponse mergechunks(Long companyId, String fileMd5, int chunkTotal,
        ...
        try {
            ...
            e.printStackTrace();
            log.error("合并文件出错, bucket: {}, objectName: {}, 错误信息: {}",
        ...
        MediaFiles mediaFiles = mediaFileService.addMediaFilesToDb(companyId,
                fileMd5, uploadFileParamsDto, bucket_video, objectname);
